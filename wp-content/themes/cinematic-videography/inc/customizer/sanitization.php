 ...
 */
function cinematicvideography_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function cinematicvideography_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function cinematicvideography_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function cinematicvideography_sanitize_float( $input ) {
 ...
 */
function cinematicvideography_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function cinematicvideography_sanitize_html( $html ) {
 ...
 */
function cinematicvideography_sanitize_image( $image, $setting ) {
 ...
 */
function cinematicvideography_sanitize_nohtml( $nohtml ) {
 ...
 */
function cinematicvideography_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function cinematicvideography_sanitize_range_value( $number, $setting ) {
 ...
 */
function cinematicvideography_sanitize_select( $input, $setting ) {
 ...
 */
function cinematicvideography_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function cinematicvideography_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function cinematicvideography_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
