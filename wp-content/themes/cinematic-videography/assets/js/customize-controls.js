( function( $ ) {
  var this_obj = cinematicvideography_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'cinematicvideography_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'cinematicvideography_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'cinematicvideography_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'cinematicvideography_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.cinematicvideography-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.cinematicvideography-customizer-tab').removeClass('active');
  ...
  jQuery.extend(api.controlConstructor, {
    'cinematicvideography-tab': api.Tab
  });
...
jQuery( document ).ready(function($) {
  ...
  $('.refresh-btn').on('click', function() {
    ...
    $.get( cinematicvideography_customizer_params.ajaxurl + '?action=' + dataValue, function( data ) {
