...
function professional_video_vlogger_global_color() {
    ...
    $professional_video_vlogger_theme_color_css = '';
	...
	';
    wp_add_inline_style( 'professional-video-vlogger-style',$professional_video_vlogger_theme_color_css );
    wp_add_inline_style( 'professional-video-vlogger-woocommerce-css',$professional_video_vlogger_theme_color_css );
...
add_filter('loop_shop_columns', 'professional_video_vlogger_loop_columns');
if (!function_exists('professional_video_vlogger_loop_columns')) {
	function professional_video_vlogger_loop_columns() {
		$professional_video_vlogger_columns = get_theme_mod( 'professional_video_vlogger_per_columns', 3 );
		return $professional_video_vlogger_columns;
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'professional_video_vlogger_per_page', 20 );
function professional_video_vlogger_per_page( $professional_video_vlogger_cols ) {
  	$professional_video_vlogger_cols = get_theme_mod( 'professional_video_vlogger_product_per_page', 9 );
	return $professional_video_vlogger_cols;
}

// Add filter to modify the number of related products
add_filter( 'woocommerce_output_related_products_args', 'professional_video_vlogger_products_args' );
function professional_video_vlogger_products_args( $args ) {
    $args['posts_per_page'] = get_theme_mod( 'custom_related_products_number', 6 );
    $args['columns'] = get_theme_mod( 'custom_related_products_number_per_row', 3 );
    return $args;
}

add_action('after_switch_theme', 'professional_video_vlogger_setup_options');
function professional_video_vlogger_setup_options () {
