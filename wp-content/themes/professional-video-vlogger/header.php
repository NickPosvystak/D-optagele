...
<?php if ( get_theme_mod('professional_video_vlogger_site_loader', false) == true ) : ?>
	<div class="cssloader">
    	<div class="sh1"></div>
    	<div class="sh2"></div>
    	<h1 class="lt"><?php esc_html_e( 'loading',  'professional-video-vlogger' ); ?></h1>
    </div>
<?php endif; ?>

<div class="<?php if( get_theme_mod( 'professional_video_vlogger_sticky_header', false) != '') { ?>sticky-header<?php } else { ?>close-sticky main-menus<?php } ?>">
